 ...
 * @file resource_mgr.h
 *
 * @brief Resource Manager Common Definitions. The Resource Manager defines
...
#ifdef C66_PLATFORMS
#define MAX_NUM_NIMU_DESC   (NIMU_NUM_TX_DESC + NIMU_NUM_RX_DESC + NIMU_MAX_NUM_TX_CMD_DESC)*2 /**< Maximum number of descriptors used by NIMU */
